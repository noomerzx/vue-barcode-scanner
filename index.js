...
var VueBarcodeScanner = {
  install: function install(Vue, options) {
    ...
    Vue.prototype.$barcodeScanner.init = function (callback) {
    ...
    Vue.prototype.$barcodeScanner.destroy = function () {
      // remove listener
      removeListener('keypress');
      removeListener('keydown');
    };

    Vue.prototype.$barcodeScanner.hasListener = function () {
      return attributes.hasListener;
    };

    Vue.prototype.$barcodeScanner.getPreviousCode = function () {
      return attributes.previousCode;
    };

    Vue.prototype.$barcodeScanner.setSensitivity = function (sensitivity) {
    ...
    function checkInputElapsedTime(timestamp) {
      ...
      if (attributes.pressedTime.length === 2) {
        ...
        var timeElapsed = attributes.pressedTime[1] - attributes.pressedTime[0];
